...
Pod::Spec.new do |s|
  ...
  s.source           = {
    :http => 'http://nexus.playnexx.net/repository/ios_libs/PluginsLibIOS/5.0.0/PluginsLibIOS.zip',
    :type => 'zip'
  }
  ...
  s.frameworks = 'UIKit', 'Foundation', 'StoreKit', 'AdSupport', 'CoreMotion', 'AppTrackingTransparency', 'AdServices', 'StoreKit', 'WebKit', 'Security', 'CryptoKit', 'AuthenticationServices'
end
